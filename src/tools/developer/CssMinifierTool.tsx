...
import { Copy, Trash2, Brush, AlignLeft, CheckCircle2 } from 'lucide-react';
                    ...
                    <div className="bg-card border border-border rounded-xl p-6 shadow-sm flex flex-col gap-4 h-full">
                        <div className="flex items-center justify-between">
                            <h2 className="text-xl font-bold flex items-center gap-2">
                                <Brush className="w-5 h-5 text-brand-primary" />
                                Input CSS
                            </h2>
                            <button
                                onClick={clearAll}
                        ...
                        <div className="flex flex-wrap items-center gap-3 pt-2">
                            ...
                            >
                                <AlignLeft className="w-5 h-5" /> Minify CSS
                            </button>
                        </div>
                    </div>
                </div>
