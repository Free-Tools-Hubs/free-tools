...
import { Copy, Trash2, FileCode2, AlignLeft, CheckCircle2 } from 'lucide-react';
...
export default function HtmlMinifierTool() {
    ...
    const minifyHtml = () => {
        ...
        // Very basic regex-based HTML minifier for client-side use without heavy libs
                ...
                <div className="flex-1 flex flex-col gap-4">
                    <div className="bg-card border border-border rounded-xl p-6 shadow-sm flex flex-col gap-4 h-full">
                        ...
                        <div className="flex flex-wrap items-center gap-3 pt-2">
                            ...
                            >
                                <AlignLeft className="w-5 h-5" /> Minify HTML
                            </button>
                        </div>
                    </div>
                </div>
